...
// Camera
const camera = new THREE.PerspectiveCamera(60, window.innerWidth / win-dow.innerHeight, 0.1, 1000);
...
video.addEventListener('ended', () => updateCTAIcon(ctaVideo, false, "Scientific Compu-ting"));
